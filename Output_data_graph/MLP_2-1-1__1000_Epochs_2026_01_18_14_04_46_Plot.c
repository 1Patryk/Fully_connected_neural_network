{
	...
	TGraph* gr1 = new TGraph(1000, x, y_training);
	gr1->SetName("gr1");
	...
	gr1->SetLineWidth(5);
	TGraph* gr2 = new TGraph(1000, x, y_validation);
	gr2->SetName("gr2");
	...
	legend->Draw();
	c1->Print("../Output_data_graph/MLP_2-1-1__1000_Epochs_2026_01_18_14_04_46_Plot.c.bmp");
}