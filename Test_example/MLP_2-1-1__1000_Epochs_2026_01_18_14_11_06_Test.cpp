...
int main()
{
	...
	float input_1_min = 86;

	float output_0_max = 101;
	float output_0_min = 94;
	...
	float Vector_of_weights_training[3] =
	{
		-1.41813e+29,
		-4.87002e+28,
		-3.51105e+29,
	...
	float Vector_of_bias_weights_training[2] =
	{
		-1.90505e+29,
		-0.171894,
	};
	...
	std::vector <float> Vector_of_neuron_values[4] = { };
